...
public class PlantUMLConstructionMessageWriter {
    public String getString(Message message) {
        ...
        return " " + PlantUMLHelper.getParticipantObjectName(message.getFrom()) + PlantUMLHelper.getTextForMessageType(message.getType()) + PlantUMLHelper.getParticipantObjectName(message.getTo()) + " ** : <<create>>";
    }
}
